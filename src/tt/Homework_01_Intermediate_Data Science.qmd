---
title: " Analysing the relationship between Fatal Car Crashes on  weekends"
---
...
Reasearch Question : How are weekends or related to fatal car crashes in the united states?
...
```{r}
# Note to myself : %>% this piping can be used only if you have installed deplyr or itdyverse 
